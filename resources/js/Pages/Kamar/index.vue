                        ...
                        <tbody>
                            <tr v-for="(room, index) in filteredRooms" :key="room.id">
                                ...
                                <td class="flex items-center space-x-2">
                                    <button @click="edit(room.id)" class="bg-white text-white px-2 py-1 rounded">
                                    ...
                                    <button @click="hapus(room.id)" class="bg-white text-white px-2 py-1 rounded">
...
onMounted(async () => {
    try {
        const response = await axios.get('/data-kamar');
