                        ...
                        <tbody>
                            <tr v-for="(guest, index) in filteredGuests" :key="guest.id">
                                ...
                                <td class="px-4 py-2 border flex items-center space-x-2">
                                    <button @click="order(guest.id)" class="bg-white text-black px-2 py-1 rounded flex items-center">
                                    ...
                                    <button @click="edit(guest.id)" class="bg-white text-black px-2 py-1 rounded flex items-center">
                                    ...
                                    <button @click="hapus(guest.id)" class="bg-white text-black px-2 py-1 rounded flex items-center">
...
onMounted(async () => {
    try {
        const response = await axios.get('/api/data-tamu/');
